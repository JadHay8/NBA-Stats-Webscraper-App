...
axios(url)
    .then(response => {
        ...
        const fs = require('fs');
        fs.writeFile("./jsonStats/pts.json",JSON.stringify(pts_per_g,null,2), err => {
            if (err){
                console.log(err);
            }
            else {
        ...
        fs.writeFile("./jsonStats/assists.json",JSON.stringify(ast_per_g,null,2), err => {
            if (err){
                console.log(err);
            }
            else {
        ...
        fs.writeFile("./jsonStats/rebounds.json",JSON.stringify(reb_per_g,null,2), err => {
            if (err){
                console.log(err);
            }
            else {
        ...
        fs.writeFile("./jsonStats/steals.json",JSON.stringify(stl_per_g,null,2), err => {
            if (err){
                console.log(err);
            }
            else {
        ...
        fs.writeFile("./jsonStats/blocks.json",JSON.stringify(blk_per_g,null,2), err => {
            if (err){
                console.log(err);
            }
            else {
